<template>
  <div class="app-wrapper" :class="{hideSidebar:!state.sidebar.opened,hoverSideBar:state.sidebar.minOpen}">
    ...
    <div class="side-wrapper" :class="{hover:!state.sidebar.minOpen,light:theme=='light'}">
      <!-- logo -->
      <div class="logo-box">
        <img :src="require('@/assets/img/logo1.png')" alt="云联合创" height="50"
             v-show="state.sidebar.opened">
        <img src=" https://cdn.itjuzi.com/images/e5cccaecae7b0bbee32cbca7dbc8b905.png?imageView2/0/w/100/q/100"
             alt="云联合创" height="40" width="40"
    ...
    <div class="main-wrapper">
        ...
        <!--<div class="messageBox" slot='msg-icon'>
          <Row>
            ...
            <Select v-model="lang" size="small" @on-change="changeLang"
                    style="width:80px;position:relative;margin-top: 12px; vertical-align: middle">
      ...
      <div class="main-container">
        <container>
         ...
         <!-- <Breadcrumb>
            <Breadcrumb-item>
              &lt;!&ndash;<Icon type="pound"></Icon>&ndash;&gt;
