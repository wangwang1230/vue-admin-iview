    ...
    <Row class="bg" :style="{background:'url('+bgUrl+')'}">
      <i-col :xs="16" offset="4">
        <Card style="margin: 100px auto;max-width: 600px;padding-top: 20px;text-align: left">
          <div v-if="token">
            ...
            <Form ref="formCustom" :model="formCustom" :rules="ruleCustom" :label-width="110">
              ...
              <Form-item label="企业名称" prop="company">
                <Input v-model="formCustom.company" placeholder="请输入企业名称"></Input>
              </Form-item>
              <!--<Form-item label="用户名" prop="company">
                <Input v-model="formCustom.company" placeholder="请输入用户名"></Input>
              </Form-item>-->
          ...
          <small style="display: block;text-align: center;line-height: 30px;"><img
            :src="require('@/assets/img/logo2.png')" height="30" alt="" style="vertical-align: top"><span>Copyright by Artiely ,All rights reserved</span>
          </small>
        </Card>
      </i-col>
    </Row>
